...
3. リージョンを選択します。続けてポリシーを可視化したいVPCをクリックし、[セキュリティグループ表示]をクリックします。
...
.. figure:: /contents/images/dome9_8_004.png
  :align: center
...
5. [内部ゾーン]のSecurity Groupをクリックします。（dome9-instanceではじまるリソースを選択します）

[内部ゾーン]にSecurity Groupが存在するということは、VPC内のリソースからアクセス可能であることを意味します。

.. figure:: /contents/images/dome9_8_006.png
  :align: center


EC2インスタンスへのリンクをクリックすると、詳細を表示する画面に遷移します。
特定のインスタンスの設定や関連するアラートをまとめて確認することができます（AWSのマネージメントコンソールは各サービス毎に画面が分かれています）。


.. figure:: /contents/images/dome9_8_007.png
  :align: center


.. figure:: /contents/images/dome9_8_008.png
  :align: center


.. figure:: /contents/images/dome9_8_009.png
  :align: center


.. figure:: /contents/images/dome9_8_010.png
  :align: center

.. figure:: /contents/images/dome9_8_011.png
  :align: center
...
1. [ネットワークセキュリティ] - [IPリスト] - [追加]をクリックします。
...
5. 作成したIP Listを利用してSecurity Groupを設定します。[ネットワークセキュリティ] - [セキュリティグループ]をクリックします。
...
8. [Port Behavior]を[Limited]に変更します。併せて、[ADD SOURCE]をクリックします。

.. figure:: /contents/images/ip_1_009.png
  :align: center


9. [IP List] - [（作成したIP List名）]を選択します。併せて、[Service Type]で[SSH]を選択し、[CREATE SERVICE]をクリックします。
...
1. [ネットワークセキュリティ] - [Dynamic Access]をクリックします。
...
1. Security Groupの設定を確認します。[Network Security] - [Security Group]をクリックします。
併せて、作成したVPCでフィルタリングを行います。
...
4. 既存のインバウンドのルールを変更し、[ルールの保存]をクリックします。
